...
- [x] **1.1 Connect and animate the certificate chain**
...
- [x] **1.2 Validate each hop and color-code the result**
...
- [x] **1.3 Fail gracefully on connection problems**
...
- [x] **2.1 Show negotiated protocol version and cipher suite**
...
- [x] **3.3 Re-run without restarting the binary**
...
- [x] **4.1 Unit test coverage for parsing and validity logic**
